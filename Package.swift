...
let package = Package(
  ...
  products: [
    ...
    .library(
      name: "SkeletonSwiftPMProjectSupport",
      targets: ["SkeletonSwiftPMProjectSupport"]
    ),
    .library(
  ...
  targets: [
    ...
    .testTarget(
      name: "SkeletonSwiftPMProjectSupportTests",
      dependencies: ["SkeletonIndexCore", "SkeletonSwiftPMProjectSupport"]
    ),
    .testTarget(
